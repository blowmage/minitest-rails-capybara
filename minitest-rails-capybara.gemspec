# -*- encoding: utf-8 -*-
# stub: minitest-rails-capybara 2.1.1.20160507192907 ruby lib

Gem::Specification.new do |s|
  s.name = "minitest-rails-capybara".freeze
  s.version = "2.1.1.20160507192907"
  ...
  s.files = [".autotest".freeze, ".gemtest".freeze, ".travis.yml".freeze, "CHANGELOG.rdoc".freeze, "Gemfile".freeze, "LICENSE".freeze, "Manifest.txt".freeze, "README.rdoc".freeze, "Rakefile".freeze, "gemfiles/4.1.gemfile".freeze, "lib/generators/minitest/feature/feature_generator.rb".freeze, "lib/generators/minitest/feature/templates/feature_spec.rb".freeze, "lib/generators/minitest/feature/templates/feature_test.rb".freeze, "lib/minitest-rails-capybara.rb".freeze, "lib/minitest/rails/capybara.rb".freeze, "minitest-rails-capybara.gemspec".freeze, "tasks/test.rake".freeze, "test/rails_helper.rb".freeze, "test/test_assertions_expectation.rb".freeze, "test/test_dsl.rb".freeze, "test/test_sanity.rb".freeze, "test/test_spec.rb".freeze, "test/test_spec_type.rb".freeze]
